...
#pragma warning disable SA1025
            ...
            var optionAbsoluteRefreshTokenLifetime = app.Option("-rtl|--refresh_token_lifelime <seconds> ",            "Absolute expiration time(seconds).",                                      CommandOptionType.SingleValue);
            var optionRefreshTokenUsage =            app.Option("-rtu|--refresh_token_usage <ReUse/OneTimeOnly>",      "Refresh token usage.",                                                    CommandOptionType.SingleValue);
            var optionRefreshTokenExpiration =       app.Option("-rte|--refresh_token_expiration <Sliding/Absolute>",  "Refresh token expiration type.",                                          CommandOptionType.SingleValue);
