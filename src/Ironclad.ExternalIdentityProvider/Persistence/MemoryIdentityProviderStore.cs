...
namespace Ironclad.ExternalIdentityProvider.Persistence
{
    ...
    public sealed class MemoryIdentityProviderStore : IStore<IdentityProvider>
    {
        private readonly ConcurrentDictionary<string, IdentityProvider> contents = new ConcurrentDictionary<string, IdentityProvider>(StringComparer.OrdinalIgnoreCase);
